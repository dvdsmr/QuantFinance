	...
	namespace Pricing
	{
		...
		namespace Exotic
		{
			namespace Asian
			{
				...
				template <typename Params>
				auto call_temp(std::size_t days, double riskFreeReturn, double maturity, double strike, double spot, double dividendYield, Params params) -> double
				{
					std::size_t numPaths{ 10000 };
					double sampleAverage{ arithmeticAverage<Params>(days, numPaths, riskFreeReturn, maturity, spot, dividendYield, params) };
					return std::max(sampleAverage / static_cast<double>(numPaths) - strike, 0.0);
				}

				template <typename Params>
				auto put_temp(std::size_t days, double riskFreeReturn, double maturity, double strike, double spot, double dividendYield, Params params) -> double
				{
					std::size_t numPaths{ 10000 };
					double sampleAverage{ arithmeticAverage<Params>(days, numPaths, riskFreeReturn, maturity, spot, dividendYield, params) };
				...
				{
					return call_temp<BSMParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<BSMParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return call_temp<BachelierParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<BachelierParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return call_temp<CEVParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<CEVParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return call_temp<MertonJumpParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<MertonJumpParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return call_temp<HestonParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<HestonParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return call_temp<VarianceGammaParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				...
				{
					return put_temp<VarianceGammaParams>(days, riskFreeReturn, maturity, strike, spot, dividendYield, params);
				}
				*/
			}
		}
